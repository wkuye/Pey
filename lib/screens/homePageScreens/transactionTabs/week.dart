...
class Week extends StatelessWidget {
  final String userID;
  const Week({super.key, required this.userID});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Flex(direction: Axis.vertical, children: [
        Expanded(
          child: FutureBuilder(
            future: GetTransactions().getTransactionsByDate(
                userID, 'week'), // Replace 1 with the actual user ID
              ...
              if (snapshot.hasData) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    var recepientBool = userID == trans.recepientID.toString();
